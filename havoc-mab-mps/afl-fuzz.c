...
EXP_ST void setup_shm(void) {
  ...
  if (!in_bitmap) memset(virgin_bits, 255, MAP_SIZE << 1);                                             //  fxm

  memset(virgin_tmout, 255, MAP_SIZE << 1);                                                            //  fxm
  memset(virgin_crash, 255, MAP_SIZE << 1);                                                            //  fxm

  shm_id = shmget(IPC_PRIVATE, MAP_SIZE << 1, IPC_CREAT | IPC_EXCL | 0600);                            //  fxm
